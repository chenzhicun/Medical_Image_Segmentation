...
class MultiResUnet(torch.nn.Module):
    def __init__(self, num_channels, num_classes, nf=32, use_dropout=False):
        super(MultiResUnet, self).__init__()
        self.n_channels = num_channels
        self.n_classes = num_classes
        self.mres_block1 = MultiResBlock(self.n_channels, u=nf)
        ...
        self.conv10 = conv2d_bn(self.mres_block9.out_channel, self.n_classes, 1, padding='same', activation='tanh')
